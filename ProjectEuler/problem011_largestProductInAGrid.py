...
def computeMaximum4Product(matrix):
    ...
    for x in range(0, sideLength):
        for y in range(0, sideLength):
            ...
            # --- check to the bottom left! (this was the forgotten one) ---
            # thanks for the hint to: https://www.mathblog.dk/greatest-product-in-20x20-grid/
            if x >= numFactors and y + numFactors < sideLength:  # prevent out of bounds!
                product = 1
                for i in range(0, numFactors):
                    product *= matrix[x - i][y + i]
                ...
                if product > biggest:
                    biggest = product
                    print("bottom left: product starting from:[", x, ",", y, "] = ", product)
...
# right: product starting from:[ 0 , 0 ] =  1651104
# right: product starting from:[ 0 , 2 ] =  6414210
# right: product starting from:[ 0 , 3 ] =  6514520
# diagonal bottom: product starting from:[ 0 , 7 ] =  11587200
# diagonal bottom: product starting from:[ 1 , 0 ] =  16194745
# right: product starting from:[ 1 , 5 ] =  25723980
# diagonal bottom: product starting from:[ 2 , 1 ] =  32719995
# bottom left: product starting from:[ 4 , 9 ] =  41076896
# right: product starting from:[ 6 , 15 ] =  51267216
# bottom left: product starting from:[ 15 , 3 ] =  70600674
# biggest: 70600674
#
...
#
# You are the 218223rd person to have solved this problem.
#
# Nice work, marcelpetrick, you've just advanced to Level 1 .
# 111783 members (11.67%) have made it this far.
#
