...
def prepareInput():
    ...
    # convert all lines to integer-lists for the list of the triangle
    # the list(map(int, ..)) converts the split result to integers
    listOfNumbers = [list(map(int, string.split(" "))) for string in inputString]
